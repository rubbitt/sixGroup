...
(function () {
  function n(n) {
    ...
    return function (t, r, e) {
      r = b(r, e);for (var u = null != t && t.length, i = n > 0 ? 0 : u - 1; i >= 0 && u > i; i += n) {
    ...
    t = d(t, r);var e, u;if (w(n)) for (e = 0, u = n.length; u > e; e++) {
      t(n[e], e, n);
    } else {
    ...
    var e,
      ...
      n = w(n) ? n : m.values(n);for (var a = 0, c = n.length; c > a; a++) {
        e = n[a], e > i && (i = e);
      }
    ...
    var e = 0,
        u = n && n.length;if ("number" == typeof r) e = 0 > r ? Math.max(0, u + r) : r;else if (r && u) return e = m.sortedIndex(n, t), n[e] === t ? e : -1;if (t !== t) return m.findIndex(l.call(n, e), m.isNaN);for (; u > e; e++) {
      if (n[e] === t) return e;
    }return -1;
  }, m.lastIndexOf = function (n, t, r) {
    var e = n ? n.length : 0;if ("number" == typeof r && (e = 0 > r ? e + r + 1 : Math.min(e, r + 1)), t !== t) return m.findLastIndex(l.call(n, 0, e), m.isNaN);for (; --e >= 0;) {
      if (n[e] === t) return e;
    }return -1;
    ...
    if (!m.isObject(n)) return [];if (h) return h(n);var t = [];for (var e in n) {
      m.has(n, e) && t.push(e);
    }return F && r(n, t), t;
  }, m.allKeys = function (n) {
    if (!m.isObject(n)) return [];var t = [];for (var e in n) {
      t.push(e);
    }return F && r(n, t), t;
  }, m.values = function (n) {
    ...
    t = b(t, r);for (var e, u = m.keys(n), i = u.length, o = {}, a = 0; i > a; a++) {
      e = u[a], o[e] = t(n[e], e, n);
    }return o;
  }, m.pairs = function (n) {
    for (var t = m.keys(n), r = t.length, e = Array(r), u = 0; r > u; u++) {
    ...
    t = b(t, r);for (var e, u = m.keys(n), i = 0, o = u.length; o > i; i++) {
    ...
    var e,
        u,
        i = {},
        o = n;if (null == o) return i;m.isFunction(t) ? (u = m.allKeys(o), e = d(t, r)) : (u = k(arguments, !1, !1, 1), e = function e(n, t, r) {
      return t in r;
    ...
    if (m.isFunction(t)) t = m.negate(t);else {
      var e = m.map(k(arguments, !1, !1, 1), String);t = function t(n, _t) {
    ...
    if (n === t) return 0 !== n || 1 / n === 1 / t;if (null == n || null == t) return n === t;n instanceof m && (n = n._wrapped), t instanceof m && (t = t._wrapped);var u = f.call(n);if (u !== f.call(t)) return !1;switch (u) {case "[object RegExp]":case "[object String]":
      ...
      var l,
          s = m.keys(n);if (c = s.length, m.keys(t).length !== c) return !1;for (; c--;) {
    ...
    var e = Array(Math.max(0, n));t = d(t, r, 1);for (var u = 0; n > u; u++) {
      e[u] = t(u);
    }return e;
